...
import { ArrowLeft, ChevronLeft, ChevronRight, Home, Mail, MapPin, Phone, Star, Users } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 animate-fade-in slide-in-from-left duration-500">
            ...
            {/* Description Section */}
            <div className="mt-8 bg-white rounded-lg p-6 shaodow-md animate-in fade-in slide-in-from-bottom duration-500 "
            ...
            >
                ...
                <p className="text-gray-600">
                    Experience ultimate comfort and luxury in this beautifully designed room. Perfect for both business and leisure travelers, this room offers everything you need for a memorable stay.
                </p>
            </div>

            {/* Amenities Section */}
            <div className="mt-8 bg-white rounded-lg p-6 shadow-md animate-in fade-in slide-in from-bottom duration-500"
            ...
            <div className="mt-8 bg-white rounded-lg shadow-md overflow-hidden animate-in fade-in slide-in-from-bottom duration-500"
                ...
                <div className="p-5 space-y-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">Staycation Haven PH, Quezon City, Metro Manila, Philippines</p>
                        </div>
                    </div>
         ...
         <div className="animate-fade-in slide-in-from-right duration-500">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 mb-6 sticky top-24">
                ...
                <div className="space-y-3">
                  ...
                  <button className="w-full border-2 border-gray-300 hover:border-orange-500 text-gray-800 hover:text-orange-600 font-semibold py-3 rounded-lg transition-all duration-300">Add to Wishlist</button>
                </div>
            </div>
         </div>
